                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="treeshop.html"><h5>Tree</h5></a>
                        </li>
                        <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <div class="category-nav-item text-center">
                            <p>Max height</br>
                                <select class="category-bar">
                                    <option value="any">Any</option>
                                    <option value="lessthan1meter">< 1m</option>
                                    <option value="onetotwometer">1 - 2m</option>
                                    <option value="twotothreemeter">2 - 3m</option>
                                    <option value="greaterthanthreemeter">> 3m</option>
                                </select>
                            </p>
                        </div>
                    </li>
                            ...
                            <p>Price Range</br>
                                <form>
                                    <div class="price-form">
                                        <p>
                                            <input type="text" id="price-one" placeholder="Any">
                                        to
                                            <input type="text" id="price-two" placeholder="Any">
                                        </p>
                                    </div>
                                </form>
                            </p>
